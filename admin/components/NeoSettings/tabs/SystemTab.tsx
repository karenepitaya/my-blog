...
export const SystemTab: React.FC = () => {
    ...
    const [backend, setBackend] = useState(MOCK_ADMIN);
                            ...
                            <div className="space-y-6">
                                ...
                                <div className={`p-4 rounded-xl bg-white/[0.02] border border-white/5 space-y-4 ${!isEditing && 'opacity-80'}`}>
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div>
                                            <label className="text-sm text-slate-500 uppercase">每页文章数</label>
                                        ...
                                        <div>
                                            <label className="text-sm text-slate-500 uppercase">推荐模式</label>
                                                ...
                                                <div key={char.id} className="p-3 bg-[#0B0C15] border border-white/5 rounded-xl flex items-center gap-3 group hover:border-white/10 transition-colors">
                                                    ...
                                                    <div className="flex-1 min-w-0 space-y-1">
                                                        ...
                                                        <div className="flex items-center gap-2">
                                                            ...
                                                            <span className="text-xs text-slate-500 font-mono">{char.enable ? 'ACTIVE' : 'DISABLED'}</span>
                                                        </div>
                                                    </div>
                                     ...
                                     {frontend.navLinks.map((nav, idx) => (
                                         <div key={nav.id} className="flex gap-2 items-center bg-[#0F111A] p-2 rounded-lg border border-white/5 overflow-hidden">
                                             ...
                                             <button 
                                                ...
                                                className={`text-xs px-1.5 py-0.5 rounded border shrink-0 transition-colors whitespace-nowrap ${nav.enableExternal ? 'border-warning text-warning' : 'border-slate-700 text-slate-600'} disabled:opacity-50`}
                                                 title="是否开启外链跳转"
                                             >
                        ...
                        <SectionTitle icon={Power} title="站点运行模式" />
                         <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            >
                                ...
                                <p className="text-sm opacity-80">正常模式：优化读者体验，开放所有访问权限。</p>
                            </div>
                            <div 
                            ...
                            >
                                ...
                                <p className="text-sm opacity-80">维护模式：重定向所有流量至维护页面，仅管理员可访问。</p>
                            </div>
                         </div>
                    </GlassCard>
                </div>
